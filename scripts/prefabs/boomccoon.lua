...
TUNING.WILSON_HUNGER_RATE = 1.25
...
for k, v in pairs(TUNING.GAMEMODE_STARTING_ITEMS) do
    start_inv[string.lower(k)] = v.BOOMCOON
end
...
local function onbecamehuman(inst)
	...
	inst.components.locomotor:SetExternalSpeedMultiplier(inst, "boomccoon_speed_mod", 1)
end
...
local master_postinit = function(inst)
	...
	inst.components.hunger.hungerrate = 1 * TUNING.BOOMCOON_HUNGER_RATE
...
return MakePlayerCharacter("boomccoon", prefabs, assets, common_postinit, master_postinit, prefabs)
